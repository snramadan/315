...
public class Commands 
{
   ...
   public Commands(ArrayList<String> icodes, ArrayList<Registers> pti, int s) 
   {
      sim = new Simulator(icodes, pti, s); 
      scanIN= new Scanner(System.in);
      temp = true;
      pl = new Pipeline();
   }

   public Commands(ArrayList<String> icodes, ArrayList<Registers> pti, File f, int s) 
   {
      sim = new Simulator(icodes, pti, s);
      pl = new Pipeline();
   ...
   private void printCommands() 
   {
      ...
      System.out.println("o = output a comma separated listing of the x,y coordinates to a file called coordinates.csv");
